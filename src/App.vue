<template>
  <NavSidebar>
    <NavSection text="Home"/>
    <NavItem text="Dashboard" material_icon="dashboard" url="dashboard"/>

    <NavSection text="Docker"/>
    <NavItem text="Containers" material_icon="dns" url="containers"/>
